...
def extract_product_data(product, category):
    try:
        ...
        product_link = product.find('a', class_='boost-sd__product-link')['href']
        print(product_link)
    ...
    return {
        ...
        'Product Link': "https://www.snitch.co.in" + product_link,
...
def extract_detailed_product_info(product_link):
    ...
    try:
        ...
        sizes_container = soup.find('div', class_='sc-4e8e8f71-0 cQtOpt hide-webkit-scrollbar')
        sizes = []
...
def scrape_products(category_url, category, writer):
    ...
    while True:
        ...
        product_cards = soup.find_all('div', class_='boost-sd__product-item boost-sd__product-item--no-border boost-sd__product-item-grid-view-layout')
...
collection_urls = [
    ...
    {'category': 'shirts', 'subcategory': 'mens-tshirts', 'url': 'https://www.snitch.co.in/collections/shirt-new'},
